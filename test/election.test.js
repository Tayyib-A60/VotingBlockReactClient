...
contract('Election', function(accounts) {
    ...
    it('initializes the two candidates with the correct params', function() {
        return Election.deployed().then(function(instance) {
            electionInstance = instance;
            return electionInstance.candidates(1);
        }).then(function(candidate) {
            assert.equal(candidate[0], 1, "contains the correct id");
            assert.equal(candidate[1], "PMB", "contains the correct name");
    ...
    it('allows voter to cast a vote', function() {
        return Election.deployed().then(function(instance) {
            ...
            assert.equal(reciept.logs[0].args._candidateId.toNumber(), candidateId,
    ...
    it('throws an exception for invalid candidate', function() {
        return Election.deployed().then(function(instance) {
            ...
            assert.equal(voteCount, 1, 'voteCount for candidate 1 was not incremented');
            return electionInstance.candidates(2);
    ...
    it('throws an exception for double voting', function() {
        return Election.deployed().then(function(instance) {
            ...
            var voteCount = candidate2[2];
            assert.equal(voteCount, 1, 'voteCount for candidate 2 was not incremented');
        });
    });
});